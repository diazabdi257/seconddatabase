...
class Lapangan4BadmintonPage extends StatefulWidget {
  const Lapangan4BadmintonPage({Key? key}) : super(key: key);

  @override
  State<Lapangan4BadmintonPage> createState() => _Lapangan4BadmintonPageState();
}

class _Lapangan4BadmintonPageState extends State<Lapangan4BadmintonPage> {
  // --- Parameter Spesifik Lapangan (UBAH INI UNTUK LAPANGAN LAIN) ---
  final String fieldId = 'lapangan4'; //
  final int pricePerHour = 60000; //
  final String sportNodeName = 'bookings_badminton'; // 'bookings_futsal' untuk futsal //
  final String orderPrefix = 'BADMINTON-L4'; // Misal 'FUTSAL-L1' untuk futsal lapangan 1 //
  final String defaultItemIdForPayload = 'B4'; // Misal 'F1' untuk futsal lapangan 1 //
  final String assetImagePath = 'assets/lapangan4badminton.jpg'; //
  final String pageTitle = "Lapangan 4 - Badminton"; //
