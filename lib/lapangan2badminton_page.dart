...
class Lapangan2BadmintonPage extends StatefulWidget {
  const Lapangan2BadmintonPage({Key? key}) : super(key: key);

  @override
  State<Lapangan2BadmintonPage> createState() => _Lapangan2BadmintonPageState();
}

class _Lapangan2BadmintonPageState extends State<Lapangan2BadmintonPage> {
  // Variabel spesifik untuk Lapangan 2
  final String fieldId = 'lapangan2';
  final int pricePerHour = 60000;
  final String sportNodeName = 'bookings_badminton';
  final String orderPrefix = 'BADMINTON-L2';
  final String defaultItemIdForPayload = 'B2';
  final String assetImagePath = 'assets/lapangan2badminton.jpg';
  final String pageTitle = "Lapangan 2 - Badminton";
  ...
  // ... (Sisa fungsi helper dan build() tidak perlu diubah)
